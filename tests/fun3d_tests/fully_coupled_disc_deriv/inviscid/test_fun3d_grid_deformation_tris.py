...
class TestFun3dGridDeformation(unittest.TestCase):
    FILENAME = "grid_deformation_tris.txt"
    ...
    def test_fun3d_grid_deformation(self):
        ...
        test_scenario = Scenario.steady("plate_grid_tris", steps=2)
        ...
        grid_interface = Fun3d14GridInterface(
            comm,
            model,
            fun3d_dir="meshes",
            complex_mode=False,
        ...
        rel_error = Fun3d14GridInterface.finite_diff_test(
            grid_interface, self.FILEPATH, ua0_scale=1e-6, adjoint_scale=1e-3
        )
        rtol = 1e-9
