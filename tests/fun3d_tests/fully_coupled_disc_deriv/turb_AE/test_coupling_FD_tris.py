...
class TestFun3dTacs(unittest.TestCase):
    ...
    def test_alpha_turbulent_aeroelastic_tris(self):
        ...
        max_rel_error = TestResult.finite_difference(
            "fun3d+tacs-turbulent-tris-aeroelastic-flow",
            model,
            driver,
    ...
    def test_thick_turbulent_aeroelastic_tris(self):
        # build the funtofem model with one body and scenario
        model = FUNtoFEMmodel("plate")
        plate = Body.aeroelastic("plate", boundary=2)
        ...
        # max_rel_error = TestResult.complex_step
        max_rel_error = TestResult.finite_difference(
            "fun3d+tacs-turbulent-tris-aeroelastic-structural",
            model,
            driver,
            TestFun3dTacs.FILEPATH,
        )
