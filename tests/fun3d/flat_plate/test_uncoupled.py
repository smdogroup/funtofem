...
class TestFun3dUncoupled(unittest.TestCase):
    ...
    def _complex_step_check(self, model, driver):
        print("Starting adjoint method...", flush=True)
        ...
        print("Finished adjoint method", flush=True)
        print("Starting complex step method...", flush=True)
