...
class TestFun3dTacsLaminar(unittest.TestCase):
    def _complex_step_check(self, test_name, model, driver):
        ...
        file_hdl = open("fun3d-tacs-turbulent.txt", "a")
    ...
    def test_laminar_aeroelastic(self):
        ...
        self._complex_step_check("fun3d+tacs-turbulent-aeroelastic", model, driver)
    ...
    def test_laminar_aerothermal(self):
        ...
        # run the complex step test on the model and driver
        self._complex_step_check("fun3d+tacs-turbulent-aerothermal", model, driver)
    ...
    def test_laminar_aerothermoelastic(self):
        ...
        # run the complex step test on the model and driver
        self._complex_step_check(
            "fun3d+tacs-turbulent-aerothermoelastic", model, driver
        )
