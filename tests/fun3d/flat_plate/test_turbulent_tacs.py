...
class TestFun3dTacsTurbulent(unittest.TestCase):
    FILENAME = "fun3d-tacs-turbulent.txt"
    ...
    def test_laminar_aeroelastic(self):
        ...
        max_rel_error = TestResult.complex_step(
            ...
            model,
            driver,
            TestFun3dTacsTurbulent.FILENAME,
        )
...
if __name__ == "__main__":
    ...
    open(TestFun3dTacsTurbulent.FILENAME, "w").close()

    full_test = True
    if full_test:
        unittest.main()
    else:
        tester = TestFun3dTacsTurbulent()
