...
class Base(object):
    ...
    # def set_derivative(self, func, var, value):
    #     """
    #     **[model call]**
    #     Set the value of a component of a derivative based on its function, variable type
    #     and the variable object.

    #     The value of the derivative must be consistent across all processors.

    #     Parameters
    #     ----------
    #     func: The function object
    #     var: The variable object
    #     value: The value of the derivative to be set
    #     """

    #     self.derivatives[func.id][vartype][var] = value
    ...
    #                         self.derivatives[vartype][func][i] += base.derivatives[
    #                             vartype
    #                         ][func][i]
    ...
    #     """
    #     for vartype in self.variables:
    #         dim = len(self.variables[vartype])
    #         self.derivatives[vartype] = []  # np.zeros(dim, dtype=TransferScheme.dtype)
