...
def writeOutputForTecplot(struct_X, aero_X, 
                          struct_disps, aero_disps,
                          struct_conn=np.array([]), aero_conn=np.array([]),
                          struct_ptr=np.array([]), aero_ptr=np.array([]),
                          struct_elem_type=0, aero_elem_type=0,
                          struct_loads=np.array([]), aero_loads=np.array([]),
