...
int main(int argc, char *argv[]) {
  ...
  int fail = meld->testAllDerivatives(US, FA, h, rtol, atol);
  if (fail) {
    printf("MELD test failed\n");
  }
  ...
  // MELDThermal *meld_thermal = new MELDThermal(comm, comm, 0, comm, 0,
  // symmetry, nn, beta); meld_thermal->setAeroNodes(XA0, aero_nnodes);
  ...
  // //TransferScheme *linmeld = new LinearizedMELD(comm, comm, 0, comm, 0, nn,
  // beta);
