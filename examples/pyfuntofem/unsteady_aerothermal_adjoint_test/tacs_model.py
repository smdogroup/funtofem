...
from pyfuntofem.tacs_aerothermal_interface_unsteady import TacsUnsteadyAerothermalInterface
import numpy as np
    ...
    def __init__(self, integrator_options, comm, tacs_comm, model, n_tacs_procs):
        ...
        if comm.Get_rank() < n_tacs_procs:
            ...
            for scenario in model.scenarios:
                self.integrator[scenario.id] = self.createIntegrator(self.assembler, integrator_options)
