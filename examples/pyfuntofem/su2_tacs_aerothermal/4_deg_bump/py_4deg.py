...
# initialize SU2
SU2_CFD_ConfigFile = 'sz_4deg_flow.cfg'
...
Iter = 0
MaxIter = 500
# running for a fixed number of iterations to ensure convergence of both fluid and structures
# each iteration in this loop is 10 iterations in su2
delta_avg_temp = 1000.0
# iterate until the absolute change in average temp between iterations is less than 0.005 deg
#while (delta_avg_temp > 0.005):
while(Iter < MaxIter):
