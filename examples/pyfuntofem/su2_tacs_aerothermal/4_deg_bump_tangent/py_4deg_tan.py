...
# initialize SU2
SU2_CFD_ConfigFile = 'sz_4deg_tan_flow.cfg'
...
# fluids and structures converge.
# if you end the iteration when the change in temperature
# is below a certain value, you might end before CFD is as converged
# as you want it to be.

# keep in mind that the su2 file runs 10 iterations in between every
# meldthermal temperature update, so this will actually be 5000 su2 iterations
delta_avg_temp = 1000.0
while(Iter < MaxIter):
...
f5.writeToFile('tacs_4deg_tan.f5')
